...
// let access_key = '69ef989817e225dd011087faf8239130';
// let loc = 'Bihar';


// let data1 = fetch('https://api.openweathermap.org/data/2.5/weather?lat=44.34&lon=10.99&appid=69ef989817e225dd011087faf8239130').then(res => res.json()).then(console.log);

// const convertData = JSON.parse(data1);
// console.log(convertData.main);
